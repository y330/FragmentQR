// The following was taken from Google Link to text fragment extension https://chrome.google.com/webstore/detail/link-to-text-fragment/pbcodcjpfjdpcineamnnmbkkmkdpajjg?hl=en
(async (browser) => {
  const DEBUG = true;

...
### Instructions
 ...
 <hr width="70%">
<h3>FAQ</h3>
<b>Whats a Text Fragment?</b> Text fragments snippets of text on a webpage specified in a URL #:~:text="*text fragment*" are appened to the end of a URL as #:~:text="any text". When opened, the text after :~:text= and the browser reads this, and know to highligh and scroll to the given text. Windows, Android, Linux) on Chromium 80+<p>
...
Y29kZSdcbiIsImhpc3RvcnkiOlstMjA3MTU0NTExMCwxMzgzNz

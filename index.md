...
<iframe width="560" height="315" src="https://www.youtube.com/embed/10U6ycpN3CQ?modestbranding=1&autoplay=1&loop=1&rel=0&showinfo=0&theme=light&autohide=0" style="border: 1px solid lightgray;padding:15px;background:#cbcbcb;border-radius:15px;-moz-box-shadow:3px 3px 3px black;-webkit-box-shadow:3px 3px 3px black;box-shadow:3px 3px 3px black;" frameborder="0"></iframe>
